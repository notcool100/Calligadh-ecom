...
const AddNewProduct = () => {
	...
	const addProduct = async () => {
		console.log(product, "this is productr");
		if (
			!product.merchantId ||
			product.title === "" ||
			...
			<div className="flex flex-col gap-y-7 xl:ml-5 max-xl:px-5 w-full">
				...
				<div className="flex gap-x-2">
					<button
						onClick={addProduct}
						type="button"
						className="uppercase bg-customGray px-10 py-5 text-lg border border-black border-gray-300 font-bold text-white shadow-sm hover:bg-blue-600 hover:text-white focus:outline-none focus:ring-2"
					>
						Add product
					</button>
				</div>
